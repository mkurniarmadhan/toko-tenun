<x-pengguna-layout>
    <div class="site-blocks-cover" style="background-image: url({{ Storage::url('produk/p1.jpeg') }});" data-aos="fade">
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="nonloop-block-3 owl-carousel">
                        <div class="item">
                            <div class="block-4 text-center">
                                <figure class="block-4-image">
                                    <img src="{{ asset('assets/images/cloth_1.jpg') }}" alt="Image placeholder"
                                        class="img-fluid">
                                </figure>
                        ...
                        <div class="item">
                            <div class="block-4 text-center">
                                <figure class="block-4-image">
                                    <img src="{{ asset('assets/images/shoe_1.jpg') }}" alt="Image placeholder"
                                        class="img-fluid">
                                </figure>
                                <div class="block-4-text p-4">
                        ...
                        <div class="item">
                            <div class="block-4 text-center">
                                <figure class="block-4-image">
                                    <img src="{{ asset('assets/images/cloth_2.jpg') }}" alt="Image placeholder"
                                        class="img-fluid">
                                </figure>
                                <div class="block-4-text p-4">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="{{ asset('assets/images/blog_1.jpg') }}" alt="Image placeholder"
