    ...
    e = {
      980: (t, e, i) => {
        ...
        function W(t, e, i) {
          ...
          e &&
            D(t) &&
            ((s = (t.offsetWidth > 0 && M(n.width) / t.offsetWidth) || 1), (o = (t.offsetHeight > 0 && M(n.height) / t.offsetHeight) || 1));
        ...
        function Q(t) {
          ...
          return i && ('html' === x(i) || ('body' === x(i) && 'static' === z(i).position))
            ? e
            : i ||
                (function (t) {
        ...
        function et(t) {
          ...
          if (p) {
            var x = Q(i),
              ...
              D = 'clientWidth';
            if (
              (x === k(i) && 'static' !== z((x = R(i))).position && 'absolute' === u && ((L = 'scrollHeight'), (D = 'scrollWidth')),
              l === n || ((l === r || l === o) && c === h))
            )
              (C = s), (y -= (m && x === O && O.visualViewport ? O.visualViewport.height : x[L]) - a.height), (y *= f ? 1 : -1);
            if (l === r || ((l === n || l === s) && c === h))
              (T = o), (b -= (m && x === O && O.visualViewport ? O.visualViewport.width : x[D]) - a.width), (b *= f ? 1 : -1);
          }
          var S,
            ...
            P =
              !0 === g
                ? (function (t) {
                    ...
                    return { x: M(e * n) / n || 0, y: M(i * n) / n || 0 };
                  })({ x: b, y })
                : { x: b, y };
          return (
            (b = P.x),
            ...
            f
              ? Object.assign(
                  ...
                  (S[T] = A ? '0' : ''),
                  (S.transform =
                    (O.devicePixelRatio || 1) <= 1 ? 'translate(' + b + 'px, ' + y + 'px)' : 'translate3d(' + b + 'px, ' + y + 'px, 0)'),
                  S)
                )
              : Object.assign({}, I, (((e = {})[C] = E ? y + 'px' : ''), (e[T] = A ? b + 'px' : ''), (e.transform = ''), e))
          );
        }
        const it = {
          name: 'computeStyles',
            ...
            null != e.modifiersData.popperOffsets &&
              ...
              null != e.modifiersData.arrow &&
                (e.styles.arrow = Object.assign(
                  {},
                  e.styles.arrow,
                  et(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: l }))
                )),
            ...
            : pt(
                (function (t) {
                  var e,
                    ...
                    l = -n.scrollTop;
                  return (
                    'rtl' === z(s || i).direction && (a += N(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
                  );
                })(R(t))
              );
        }
        ...
        function bt(t, e) {
          ...
          var i = e,
            ...
            I = _t({ reference: S, element: x, strategy: 'absolute', placement: a }),
            ...
            if (!e.modifiersData[h]._skip) {
              for (
                      ...
                      P(i) === a
                        ? (function (t, e) {
                            ...
                            var p = f.reduce(function (e, i) {
                              return (e[i] = bt(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[P(i)]), e;
                            }, {});
                            return Object.keys(p).sort(function (t, e) {
                              return p[t] - p[e];
                            });
                          })(e, { placement: i, boundary: v, rootBoundary: y, padding: b, flipVariations: E, allowedAutoPlacements: T })
                        : i
                    );
                  }, []),
                  L = e.rects.reference,
                ...
                var M = k[j],
                  ...
                  W = [n, s].indexOf(H) >= 0,
                  B = W ? 'width' : 'height',
                  F = bt(e, { placement: M, boundary: v, rootBoundary: y, altBoundary: w, padding: b }),
                  z = W ? ($ ? o : r) : $ ? s : n;
                L[B] > D[B] && (z = rt(z));
                var q = rt(z),
                  R = [];
        ...
        const Et = {
          ...
          fn: function (t) {
            var e = t.state,
                ...
                return (
                  (t[i] = (function (t, e, i) {
                    var s = P(t),
                      ...
                      c = l[0],
                      h = l[1];
                    return (c = c || 0), (h = (h || 0) * a), [r, o].indexOf(s) >= 0 ? { x: h, y: c } : { x: c, y: h };
                  })(i, e.rects, l)),
                  t
                );
              }, {}),
              ...
              d = h.x,
              u = h.y;
            null != e.modifiersData.popperOffsets && ((e.modifiersData.popperOffsets.x += d), (e.modifiersData.popperOffsets.y += u)),
              (e.modifiersData[s] = c);
          }
        };
        const Tt = {
        ...
        const Ct = {
          ...
          fn: function (t) {
            var e = t.state,
              ...
              v = i.tetherOffset,
              y = void 0 === v ? 0 : v,
              w = bt(e, { boundary: f, rootBoundary: p, padding: m, altBoundary: g }),
              A = P(e.placement),
              E = Z(e.placement),
              T = !E,
              C = X(A),
        ...
        function Ot(t, e, i) {
          ...
          return (
            (o || (!o && !i)) &&
              (('body' !== x(e) || dt(a)) &&
                (c = (n = e) !== k(n) && D(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : ct(n)),
              D(e) ? (((h = W(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = ht(a))),
              ...
              h = {
                ...
                setOptions: function (i) {
                  ...
                  d(),
                    ...
                    (a.scrollParents = { reference: L(t) ? ft(t) : t.contextElement ? ft(t.contextElement) : [], popper: ft(e) });
                  var r = (function (t) {
                    var e = xt(t);
                ...
                forceUpdate: function () {
                  if (!c) {
                    var t = a.elements,
                      ...
                      i = t.popper;
                    if (Lt(e, i)) {
                      (a.rects = { reference: Ot(e, Q(i), 'fixed' === a.options.strategy), popper: B(i) }),
                        (a.reset = !1),
        ...
        var St = Dt(),
          It = Dt({ defaultModifiers: [st, Tt, it, I, Et, vt, Ct, J, At] }),
      ...
      666: function (t, e, i) {
        t.exports = (function (t) {
            ...
            if (t)
              for (const i in t)
                if ('default' !== i) {
                  ...
                  Object.defineProperty(e, i, n.get ? n : { enumerable: !0, get: () => t[i] });
                }
                ...
                ? (function (t, e, i) {
                    return function n(s) {
                      ...
                      for (let { target: r } = s; r && r !== this; r = r.parentNode)
                        for (const a of o)
                          if (a === r) return $(s, { delegateTarget: r }), n.oneOff && H.off(t, s.type, e, i), i.apply(r, [s]);
                    };
                  })(t, i, r)
                : (function (t, e) {
                    return function i(n) {
          ...
          const H = {
            ...
            off(t, e, i, n) {
              ...
              const [s, o, r] = I(e, i, n),
                ...
                h = e.startsWith('.');
              if (void 0 === o) {
                if (h) for (const i of Object.keys(l)) j(t, l, i, e.slice(1));
          ...
          class Z extends R {
            ...
            _initEvents() {
              this._supportPointerEvents
                ? (H.on(this._element, 'pointerdown.bs.swipe', t => this._start(t)),
                  H.on(this._element, 'pointerup.bs.swipe', t => this._end(t)),
                  this._element.classList.add('pointer-event'))
                : (H.on(this._element, 'touchstart.bs.swipe', t => this._start(t)),
            ...
            _addEventListeners() {
              this._config.keyboard && H.on(this._element, 'keydown.bs.carousel', t => this._keydown(t)),
                'hover' === this._config.pause &&
                  (H.on(this._element, 'mouseenter.bs.carousel', () => this.pause()),
              ...
              if (
                (this._config.parent &&
                  (t = this._getFirstLevelChildren('.collapse.show, .collapse.collapsing')
                    ...
                    .map(t => _t.getOrCreateInstance(t, { toggle: !1 }))),
          ...
          H.on(document, 'click.bs.collapse.data-api', pt, function (t) {
            ...
            const e = o(this),
              i = U.find(e);
            for (const t of i) _t.getOrCreateInstance(t, { toggle: !1 }).toggle();
          }),
            b(_t);
          const bt = 'dropdown',
            vt = 'ArrowUp',
            ...
            _getPopperConfig() {
              ...
              return (
                (this._inNavbar || 'static' === this._config.display) &&
                  (q.setDataAttribute(this._menu, 'popper', 'static'), (t.modifiers = [{ name: 'applyStyles', enabled: !1 }])),
          ...
          class se extends V {
            ...
            show(t) {
              this._isShown ||
                ...
                H.trigger(this._element, Jt, { relatedTarget: t }).defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
          ...
          const pe = new Set(['background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href']),
            ...
            _e = (t, e) => {
              ...
              return e.includes(i)
                ? !pe.has(i) || Boolean(ge.test(t.nodeValue) || me.test(t.nodeValue))
          ...
          const Ee = new Set(['sanitize', 'allowList', 'sanitizeFn']),
            ...
            ke = 'hover',
            Le = 'focus',
            De = { AUTO: 'auto', TOP: 'top', RIGHT: _() ? 'left' : 'right', BOTTOM: 'bottom', LEFT: _() ? 'right' : 'left' },
            Se = {
              allowList: be,
              animation: !0,
              boundary: 'clippingParents',
            ...
            show() {
              ...
              if (
                (this._element.ownerDocument.documentElement.contains(this.tip) ||
                  (n.append(i), H.trigger(this._element, this.constructor.eventName('inserted'))),
          ...
          const Ne = {
            ...
            je = { ...Pe.DefaultType, content: '(null|string|element|function)' };
          class Me extends Pe {
            static get Default() {
              return Ne;
            }
          ...
          const He = 'click.bs.scrollspy',
            $e = 'active',
            We = '[href]',
            Be = { offset: null, rootMargin: '0px 0px -25%', smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
            Fe = { offset: '(number|null)', rootMargin: 'string', smoothScroll: 'boolean', target: 'element', threshold: 'array' };
          class ze extends V {
            constructor(t, e) {
              super(t, e),
            ...
            _process(t) {
              this._activeTarget !== t &&
                ...
                H.trigger(this._element, 'activate.bs.scrollspy', { relatedTarget: t }));
            }
            _activateParents(t) {
          ...
          class Je extends V {
            ...
            show() {
              ...
              const e = this._getActiveElem(),
                i = e ? H.trigger(e, 'hide.bs.tab', { relatedTarget: t }) : null;
              H.trigger(t, 'show.bs.tab', { relatedTarget: e }).defaultPrevented ||
                  ...
                  () => {
                    'tab' === t.getAttribute('role')
                      ? (t.removeAttribute('tabindex'),
                        ...
                        H.trigger(t, 'shown.bs.tab', { relatedTarget: e }))
                      : t.classList.add(Ye);
                  },
                  t,
                  ...
                  () => {
                    'tab' === t.getAttribute('role')
                      ? (t.setAttribute('aria-selected', !1),
                        ...
                        H.trigger(t, 'hidden.bs.tab', { relatedTarget: e }))
