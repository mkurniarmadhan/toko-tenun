                ...
                e.exports = function (e, t, n, p, u, b, w) {
                  ...
                  if (
                    (Y &&
                      ...
                      y !== Object.prototype &&
                        _.next &&
                        (d || r(_) === y || (l ? l(_, y) : 'function' != typeof _[x] && s(_, x, j)), a(_, L, !0, !0), d && (h[L] = j))),
                    u == g &&
                      z &&
                      z.name !== g &&
                      ((H = !0),
              ...
              './node_modules/core-js/internals/object-create.js': function (e, t, n) {
                ...
                (e.exports =
                  ...
                  function (e, t) {
                    var n;
                    return (
                      null !== e ? ((p.prototype = i(e)), (n = new p()), (p.prototype = null), (n[c] = e)) : (n = d()),
                      void 0 === t ? n : o(n, t)
                    );
                  }),
                  (l[c] = !0);
                ...
                o('inspectSource', function (e) {
                  ...
                  (e.exports = function (e, t, n, o) {
                    var s = !!o && !!o.unsafe,
                      ...
                      p = !!o && !!o.noTargetGet;
                    'function' == typeof n &&
                      ('string' != typeof t || l(n, 'name') || r(n, 'name', t), (d(n).source = h.join('string' == typeof t ? t : ''))),
                ...
                var c = (function () {
                  function e(t, n) {
                    ...
                    s(this, e),
                      ...
                      (this.contents = n),
                      (this.tags = o),
                      (this.attrs = i({}, l.default, { class: 'feather feather-' + t }));
                  }
                  return (
                    o(e, [
                      {
          ...
          function m(e) {
            ...
            (e.containerWidth = n(r.width)),
              ...
              e.scrollbarYActive
                ...
                : (i.classList.remove(w.state.active('y')), (e.scrollbarYHeight = 0), (e.scrollbarYTop = 0), (i.scrollTop = 0));
          }
          function g(e, t) {
            var n = Math.min,
              i = Math.max;
                ...
                e.event.bind(e.ownerDocument, 'keydown', function (t) {
                  if (!((t.isDefaultPrevented && t.isDefaultPrevented()) || t.defaultPrevented) && (o() || l())) {
                    ...
                    (e.settings.suppressScrollX && 0 !== a) ||
                      ...
                      ((i.scrollTop -= s), (i.scrollLeft += a), m(e), n(a, s) && t.preventDefault());
                  }
                });
              },
              wheel: function (i) {
                  ...
                  if (!l(e.target, n, a)) {
                    ...
                    i.settings.useBothWheelAxes
                      ? i.scrollbarYActive && !i.scrollbarXActive
                        ...
                        : i.scrollbarXActive &&
                          !i.scrollbarYActive &&
                          (n ? (s.scrollLeft += n * i.settings.wheelSpeed) : (s.scrollLeft -= a * i.settings.wheelSpeed), (c = !0))
                ...
                void 0 === window.onwheel
                  ? void 0 !== window.onmousewheel && i.event.bind(s, 'mousewheel', a)
                    ...
                    : L.supportsIePointer &&
                      (window.PointerEvent
                        ...
                        : window.MSPointerEvent &&
                          (i.event.bind(h, 'MSPointerDown', s), i.event.bind(h, 'MSPointerMove', p), i.event.bind(h, 'MSPointerUp', d)));
                }
              }
            },
            z = function (e, r) {
              ...
              (this.scrollbarXBottom = parseInt(p.bottom, 10)),
                isNaN(this.scrollbarXBottom)
                  ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = y(p.top)))
              ...
              (this.scrollbarYRight = parseInt(d.right, 10)),
                isNaN(this.scrollbarYRight)
                  ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = y(d.left)))
      ...
      if (!n) {
        ...
        for (p = 0; p < e.length; p++) {
          for (var [n, o, r] = e[p], a = !0, s = 0; s < n.length; s++)
            (!1 & r || l >= r) && Object.keys(i.O).every(e => i.O[e](n[s])) ? n.splice(s--, 1) : ((a = !1), r < l && (l = r));
          if (a) {
            e.splice(p--, 1);
            var c = o();
            void 0 !== c && (t = c);
