...
!(function (e, t) {
  ...
  const t = e => {
    ...
    q = (e, t) => {
      ...
      switch (t) {
        ...
        case 'radio':
          return (
            e.querySelector(`.${n.popup} > .${n.radio} input:checked`) || e.querySelector(`.${n.popup} > .${n.radio} input:first-child`)
          );
        case 'range':
      ...
      new Promise(t => {
        ...
        (Q.restoreFocusTimeout = setTimeout(() => {
          Q.previousActiveElement instanceof HTMLElement
            ? (Q.previousActiveElement.focus(), (Q.previousActiveElement = null))
        ...
        (function (e, t, o) {
          ...
          ue(i, 'confirm', o),
            ...
            (function (e, t, o, i) {
              ...
              F([e, t, o], n.styled),
                i.confirmButtonColor && ((e.style.backgroundColor = i.confirmButtonColor), F(e, n['default-outline']));
            ...
            o.reverseButtons &&
              (o.toast ? (e.insertBefore(r, i), e.insertBefore(s, i)) : (e.insertBefore(r, t), e.insertBefore(s, t), e.insertBefore(i, t)));
        })(o, i, t),
        H(i, t.loaderHtml),
        D(i, t, 'loader');
    };
  ...
  const pe = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'],
    ...
    we = (e, t) => {
      ['string', 'number'].includes(typeof t)
        ? (e.value = `${t}`)
        : p(t) || s(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${typeof t}"`);
    },
    ve = {};
  (ve.text =
    ve.email =
    ...
    ve.tel =
    ve.url =
      (e, t) => (we(e, t.inputValue), be(e, e, t), fe(e, t), (e.type = t.input), e)),
        ...
        setTimeout(() => {
          if ('MutationObserver' in window) {
            ...
            new MutationObserver(() => {
              const n =
                e.offsetWidth +
                ((o = e), parseInt(window.getComputedStyle(o).marginLeft) + parseInt(window.getComputedStyle(o).marginRight));
              var o;
        ...
        ((t, n) => {
          ...
          if (n.icon || n.iconHtml) {
            if (n.icon && -1 === Object.keys(o).indexOf(n.icon))
              return r(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${n.icon}"`), void z(s);
  ...
  const We = () => {
    ...
    Ye = e => {
      ...
      return (
        ...
        !Je(e) &&
        (t === n ||
          (!J(n) && t instanceof HTMLElement && 'INPUT' !== t.tagName && 'TEXTAREA' !== t.tagName && (!J(w()) || !w().contains(t))))
      );
    },
  ...
  function Ge(e, t, o, i) {
    ...
    /^((?!chrome|android).)*safari/i.test(navigator.userAgent)
      ...
      O() &&
        (null !== M.previousBodyPadding &&
          ((document.body.style.paddingRight = `${M.previousBodyPadding}px`), (M.previousBodyPadding = null)),
        (() => {
  ...
  var At = Object.freeze({
    ...
    _destroy: function () {
      ...
      n
        ? (t.popup && Q.swalCloseEventFinishedCallback && (Q.swalCloseEventFinishedCallback(), delete Q.swalCloseEventFinishedCallback),
        ...
        'object' != typeof e[0] || Wt(e[0])
          ? ['title', 'html', 'icon'].forEach((n, o) => {
              ...
              'string' == typeof i || Wt(i)
                ? (t[n] = i)
                : void 0 !== i && r(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`);
            })
          : Object.assign(t, e[0]),
        t
      );
    ...
    !(function (e) {
      ...
      (function (e) {
        (!e.target ||
          ...
          (s('Target parameter is not valid, defaulting to "body"'), (e.target = 'body'));
      })(e),
  ...
  const wn = (t, n, o) =>
    ...
    Bn = (e, t) =>
      t.focusDeny && Z(e.denyButton)
        ...
        : !(!t.focusConfirm || !Z(e.confirmButton)) && (e.confirmButton.focus(), !0),
    Pn = () => {
